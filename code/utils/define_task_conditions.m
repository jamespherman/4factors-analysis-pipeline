...
% D. ROC Analysis Plan
% Each element defines a bin-by-bin ROC comparison. The plan is
% "rectangular" to ensure a complete grid of data for downstream plotting
% and to add valuable scientific controls.
roc_plan_def = { ...
    % Comparison Type: Dist (Distractor Location)
    'Dist', 'CUE_ON',    'is_in_rf',         'is_out_of_rf',     '',           false; ...
    'Dist', 'outcomeOn', 'is_in_rf',         'is_out_of_rf',     '',           false; ...
    'Dist', 'reward',    'is_in_rf',         'is_out_of_rf',     '',           false; ...
    % Comparison Type: RPE (Reward Prediction Error)
    'RPE',  'CUE_ON',    'is_high_reward',   'is_low_reward',    'is_in_rf',   false; ...
    'RPE',  'outcomeOn', 'is_high_reward',   'is_low_reward',    'is_in_rf',   false; ...
    'RPE',  'reward',    'is_high_reward',   'is_low_reward',    'is_in_rf',   false; ...
    % Comparison Type: SPE (Salience Prediction Error)
    'SPE',  'CUE_ON',    'is_high_salience', 'is_low_salience',  'is_in_rf',   true;  ...
    'SPE',  'outcomeOn', 'is_high_salience', 'is_low_salience',  'is_in_rf',   true;  ...
    'SPE',  'reward',    'is_high_salience', 'is_low_salience',  'is_in_rf',   true   ...
};
condition_defs.roc_plan = struct('name', {}, 'event', {}, 'cond1', {}, ...
    'cond2', {}, 'trial_mask', {}, 'is_av_only', {});
for i = 1:size(roc_plan_def, 1)
    ...
    condition_defs.roc_plan(i).is_av_only = roc_plan_def{i, 6};
end
