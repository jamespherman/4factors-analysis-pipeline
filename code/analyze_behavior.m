...
% entry in the behavior_plan. It calculates a dependent variable (e.g.,
% reaction time), retrieves pre-computed categorical factors from the
...
%                       It contains logical masks for trial conditions
%                       and a `factors` sub-struct with pre-computed
